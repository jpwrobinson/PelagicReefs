...
\begin{center}\includegraphics[width=0.95\linewidth]{fig/FigureSX_map_ill} \end{center}

\textbf{Fig. S1} \textbar{} Map of islands analysed for IME and fish
energy flux across the tropical Pacific. IME strength was measured at 34
island or island complexes, which were Saipan (Saipan, Tinian, Aguijan),
Maui (Maui, Molokai, Lanai), and Tau (Tau, Ofu \& Olosega). Fish surveys
were conducted at 34 islands, separately each each complex island. We
excluded Johnston, Laysan, and Wake due to lack of site-level
bathymetry.

\begin{landscape}


\begin{center}\includegraphics[width=0.75\linewidth]{fig/FigureSX_IME} \end{center}
...
\begin{center}\includegraphics[width=0.85\linewidth]{fig/FigureSX_IME_pred} \end{center}
...
\begin{center}\includegraphics[width=0.85\linewidth]{fig/FigureSX_IME_seasonal_pred} \end{center}
...
\begin{center}\includegraphics[width=0.95\linewidth]{fig/FigureSX_MLD_amp} \end{center}
...
\begin{center}\includegraphics[width=0.95\linewidth,height=0.8\textheight]{fig/FigureSX_metab} \end{center}
...
\begin{center}\includegraphics[width=0.95\linewidth,height=0.8\textheight]{fig/FigureSX_planktivore_time} \end{center}
...
\begin{center}\includegraphics[width=0.95\linewidth]{fig/FigureSX_herbivore_time} \end{center}
...
\begin{center}\includegraphics[height=0.85\textheight]{fig/FigureSX_MLD_time_obs} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{fig/FigureSX_IME_time_covariates} \end{center}

\textbf{Fig. S10} \textbar{} Effects of mixed layer depth covariates on
IME dynamics from 1997-2025. Top-row is probability of detecting an IME
and bottom-row is IME strength (\%), for mean mixed layer depth (a, d),
mixed layer depth anomaly (b, e), and the mixed layer change from
1993-2026 (c, f). Lines are median posterior estimates with 95\% and
50\% certainty intervals. Histograms show underlying data distribution
of each covariate along x-axis.

\newpage
\begin{landscape}


\begin{center}\includegraphics[width=0.9\linewidth]{fig/FigureSX_IME_temporalFullDetect} \end{center}
...
\begin{center}\includegraphics[width=0.9\linewidth]{fig/FigureSX_IME_temporalFullGamma} \end{center}

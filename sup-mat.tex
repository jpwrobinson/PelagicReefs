...
\begin{center}\includegraphics[width=0.85\linewidth]{fig/FigureSX_IME} \end{center}
...
\begin{center}\includegraphics[width=0.95\linewidth]{fig/FigureSX_IME_pred} \end{center}
...
\begin{center}\includegraphics[width=0.95\linewidth]{fig/FigureSX_IME_seasonal_pred} \end{center}
...
\textbf{Fig. S5} \textbar{} Seasonal variability in the mixed layer
depth at each island. In a, lines are predicted mixed layer depth at
each island from a general additive model of time and month, overlaid
with points indicating timing of coral reef fish surveys. Predicted
values were used to estimate b the mixed layer depth seasonal amplitude
at each island, or the range of depths experienced by each island from
Jan to Dec. \newpage

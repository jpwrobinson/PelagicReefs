...
layer depth layer from 1997-2026. Lines are mean predicted mixed layer
from a generalised additive model, for each region (black with 95\% CI
filled by region), overlaid with mean island predictions (coloured
lines).
